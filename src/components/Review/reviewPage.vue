    ...
    <v-main class="list">
        ...
        <v-data-table :headers="headers" :items="reviews" :search="search">
            <template v-slot:[`item`]="{ item }" class="col-sm">
                <v-card color="#CACACA" dark max-width="850" style="margin: 30px" shaped outlined>
                    <v-card-title>
                    ...
                    <v-card-actions>
                        <v-list-item class="grow">
                            ...
                            <v-row align="center" justify="end">
                                <v-btn color="#CACACA" small class="mr-2" @click="editHandler(item)">
        ...
        <v-dialog v-model="dialog" persistent width="1000px" elevation="0">
            <v-card style="margin-top: 150px">
                ...
                <v-form ref="form" v-model="valid" lazy-validation>
                    <v-card-text>
                        <v-container>
                            <v-text-field v-model="namaLengkap" label="Nama" :rules="nameRules" disabled>
                            </v-text-field>

                            <v-text-field v-model="email" label="Email" :rules="emailRules" disabled></v-text-field>
